...
func (he HourlyEmployee) String() string {
	return fmt.Sprintf("Name: %s, (Hourly: $%.2f, Hours Worked: %.2f)", he.Name, he.HourlyRate, he.HoursWorked)
}
...
func PrintEmployeeSummary[P fmt.Stringer](employee P) {
	fmt.Printf(" - Processing: %s\n", employee) // Relies on Stringer interface all employees should implement String() method
}
...
func main() {
	...
	payrollList := []Payable{
		...
		hrEmp,
		comEmp,
		HourlyEmployee{Name: "Diana Prince", HourlyRate: 30.00, HoursWorked: 150},
	}
